...
//ol.proj.get("EPSG:27700").setExtent([509319.982015, 177902.383594, 522271.330485, 186020.491406]);
var wms_layers = [];
...
var group_Ealing = new ol.layer.Group({
                                layers: [lyr_Actors800mwalkingcatchment_1,lyr_Selectedneighbourhood_2,lyr_Ealingactors_3,],
                                fold: 'open',
                                title: 'Ealing'});

lyr_OpenStreetMap_0.setVisible(true);lyr_Actors800mwalkingcatchment_1.setVisible(true);lyr_Selectedneighbourhood_2.setVisible(true);lyr_Ealingactors_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,group_Ealing];
lyr_Actors800mwalkingcatchment_1.set('fieldAliases', {'qc_id': 'qc_id', 'id': 'id', 'actor_name': 'actor_name', 'category': 'category', });
...
lyr_Actors800mwalkingcatchment_1.set('fieldImages', {'qc_id': 'Range', 'id': 'TextEdit', 'actor_name': 'TextEdit', 'category': 'TextEdit', });
...
lyr_Actors800mwalkingcatchment_1.set('fieldLabels', {'qc_id': 'no label', 'id': 'no label', 'actor_name': 'no label', 'category': 'no label', });
