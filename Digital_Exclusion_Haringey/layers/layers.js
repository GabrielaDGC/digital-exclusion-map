...
//ol.proj.get("EPSG:27700").setExtent([528840.868615, 187467.904662, 536202.246267, 192082.131324]);
var wms_layers = [];
...
var format_Actors800mwalkingcatchment_1 = new ol.format.GeoJSON();
var features_Actors800mwalkingcatchment_1 = format_Actors800mwalkingcatchment_1.readFeatures(json_Actors800mwalkingcatchment_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:27700'});
var jsonSource_Actors800mwalkingcatchment_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Actors800mwalkingcatchment_1.addFeatures(features_Actors800mwalkingcatchment_1);
var lyr_Actors800mwalkingcatchment_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Actors800mwalkingcatchment_1, 
                style: style_Actors800mwalkingcatchment_1,
                popuplayertitle: 'Actors - 800m walking catchment',
                interactive: false,
                title: '<img src="styles/legend/Actors800mwalkingcatchment_1.png" /> Actors - 800m walking catchment'
            });
...
var group_Haringey = new ol.layer.Group({
                                layers: [lyr_Actors800mwalkingcatchment_1,lyr_Selectedneighbourhoods_2,lyr_Haringeyactors_3,],
                                fold: 'open',
                                title: 'Haringey'});

lyr_OpenStreetMap_0.setVisible(true);lyr_Actors800mwalkingcatchment_1.setVisible(true);lyr_Selectedneighbourhoods_2.setVisible(true);lyr_Haringeyactors_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,group_Haringey];
lyr_Actors800mwalkingcatchment_1.set('fieldAliases', {'qc_id': 'qc_id', 'id': 'id', 'actor_name': 'actor_name', 'category': 'category', 'parking': 'parking', 'accessibility_ramp': 'accessibility_ramp', 'an_updated_webpage': 'an_updated_webpage', 'required_e-booking': 'required_e-booking', 'opening_hours': 'opening_hours', 'WiFi (free)': 'WiFi (free)', 'PCs_to_use': 'PCs_to_use', 'digital_devices_loan': 'digital_devices_loan', });
...
lyr_Actors800mwalkingcatchment_1.set('fieldImages', {'qc_id': 'Range', 'id': 'TextEdit', 'actor_name': 'TextEdit', 'category': 'TextEdit', 'parking': '', 'accessibility_ramp': '', 'an_updated_webpage': '', 'required_e-booking': '', 'opening_hours': '', 'WiFi (free)': '', 'PCs_to_use': '', 'digital_devices_loan': '', });
...
lyr_Actors800mwalkingcatchment_1.set('fieldLabels', {'qc_id': 'no label', 'id': 'no label', 'actor_name': 'no label', 'category': 'no label', 'parking': 'no label', 'accessibility_ramp': 'no label', 'an_updated_webpage': 'no label', 'required_e-booking': 'no label', 'opening_hours': 'no label', 'WiFi (free)': 'no label', 'PCs_to_use': 'no label', 'digital_devices_loan': 'no label', });
