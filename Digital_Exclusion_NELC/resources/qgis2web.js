...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [519920.621022, 401788.304098, 533765.462296, 409433.202659], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:27700',
            //extent: [524147.407155, 402294.785769, 530881.233533, 408976.373348],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([519920.621022, 401788.304098, 533765.462296, 409433.202659], map.getSize());
    ...
    element: (() => {
        ...
        if (728 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Geospatial mapping revealed:<br />&bull; Limited social connection as high proportion of one-person households,<br />&bull; Affordability barriers - devices and broadband speed may be limited,<br />&bull; Lack of motivation to use digital devices; strong preference for in-person/paper methods.<br /><br /><br />This neighbourhood has a strong presence of trusted assets that are local to residents such as Waltham Library and Friendship@Home who deliver digital drop-ins in the local church and at-home visits. The Behavioural Systems Map suggests that the current support offer can benefit from stronger coordination, while the informal support is present but unevenly distributed, potentially reinforcing inequalities for those who are socially isolated. ';
            }
